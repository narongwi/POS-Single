...
namespace BJCBCPOS.Services.Controls {
    ...
    public class CustomToggle : Control {
        ...
        [Category("Custom Control"), Description("Toggle button Show or hide Text")]
        ...
        [Category("Custom Control"), Description("Toggle button on")]
        public bool IsOn {
            get =>
                this.isON;
            set {
        ...
        [Category("Custom Control"), Description("Toggle button border color")]
        ...
        [Category("Custom Control"), Description("Toggle button On Text")]
        ...
        [Category("Custom Control"), Description("Toggle button Off Text")]
        ...
        [Category("Custom Control"), Description("Toggle button On Color")]
        ...
        [Category("Custom Control"), Description("Toggle button Off Color")]
